 ...
 * @property {Array} elementRef display node's element references
 * @property {Array} selectors display node's selectors
 * @property {Array} xpath display node's xpaths
 */
